...
print("The area of that circle is:", math.pi * float(radius)**2)

#%%
# ----------------------------------------------------------------------
# 5. Write a Python program which accepts the user's first and last name and
#  print them in reverse order with a space between them.
uname = input("Enter first name and last name: ")
splitname = uname.split()
print("Last name first would be:", splitname[1], splitname[0])
...
string_of_input = input("Enter a string of numbers with spaces in between: ")
o_list = [float(x) for x in string_of_input.split()]
print ("List:", o_list)
print ("Tuple:", tuple(o_list))
...
print("Extension is:", splitname[-1])
import os
print("Or if you prefer:", os.path.splitext(filename)[1])

#%%
# ----------------------------------------------------------------------
# 8. Write a Python program to display the first and last colors from the following list.
colors = ['red', 'white', 'blue']
print("First and last:", colors[0], colors[-1])
...
nint = int(n)
print("Results = ", nint + 2*nint + 3*nint)
...
import datetime
date1 = datetime.date(1976, 12, 25)
date2 = datetime.date(1977,2,26)
td = date2 - date1
print("Date delta is {0} days.".format(td.days))
#%%
# ----------------------------------------------------------------------
# 15. Write a Python program to get the volume of a sphere with radius 6.
import math
R = 6
print("The area of a sphere with radius {0} is:".format(R), 4 * math.pi * (R**3)/3)
...
# of the first 2 characters of a given string. Return the n copies of
...
a = ['a', 'b', 'c']
print("List:", a, "Concatenated together:", ''.join(a))
...
color_list_1 = ['red', 'yellow', 'blue', 'green', 'indigo']
color_list_2 = ['red', 'white', 'blue']

uniques = set([x for x in color_list_1 if x not in color_list_2])
print("Unique colors are:", uniques)
#%%
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# 77. Write a Python program to test whether the system is a big-endian
...
def get_me():
    print("get my source")
print(inspect.getsource(get_me))
...
# ----------------------------------------------------------------------
# 104. Write a Python program to get the effective group id, effective
#  user id, real group id, a list of supplemental group ids associated
...
# ----------------------------------------------------------------------
# 108. Write a Python program to find path refers to a file or directory
...
# ----------------------------------------------------------------------
# 113. Write a Python program to input a number, if it is not a number
...
# ----------------------------------------------------------------------
# 117. Write a Python program to prove that two string variables of same
#  value point same memory location.
...
# ----------------------------------------------------------------------
# 120. Write a Python program to format a specified string to limit
#  the number of characters to 6

#%%
# ----------------------------------------------------------------------
# 121. Write a Python program to determine if variable is defined or not.
print ("YES" if 'fred' in locals() else "NO")
#%%
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# 137. Write a Python program to extract single key-value pair
#  of a dictionary in variables.
#%%
# ----------------------------------------------------------------------
# 138. Write a Python program to convert true to 1 and false to 0.
def numberfy(boolval):
    return 1 if boolval else 0

print("True is:", numberfy(True))
print("False is:", numberfy(False))
#%%
# ----------------------------------------------------------------------
...
# ----------------------------------------------------------------------
# 142. Write a Python program to find the operating system name,
#  platform and platform release date.


# ----------------------------------------------------------------------
# 143. Write a Python program to determine if the python shell is
# executing in 32bit or 64bit mode on operating system.
...
# ----------------------------------------------------------------------
# 147. Write a Python function to check whether a number is divisible
# by another number. Accept two integers values form the user.

# ----------------------------------------------------------------------
# 148. Write a Python function to find the maximum and minimum numbers
# from a sequence of numbers. Go to the editor

# ----------------------------------------------------------------------
# 149. Write a Python function that takes a positive integer and returns
# the sum of the cube of all the positive integers smaller than the
# specified number.
